...
public class auto_0plus5_afkbot_pro extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            path_follower.goToPosWithArm(57, 34.2, -Math.PI / 2); /* sample 2 */
            waitArmRotation();
            waitArmExtension();
            takeSample(false);
            ...
            path_follower.goToPosWithArmThirdSample(58, 34, -Math.PI / 2 + Math.toRadians(40.3)); /* intaking yellow 3 */
            ...
            module_master.arm.setRotation(arm.rotation.LIFT);
            module_master.differential.pitchHalfDown();
            path_follower.goToPosWithArmToBasket(51.7, 50, -Math.PI * 3 / 4 + Math.toRadians(10));
            setExtensionAndWait(arm.extension.EXTENDED);
            ...
            path_follower.goToPosVeryUnsafe(19, 6, -Math.PI);
